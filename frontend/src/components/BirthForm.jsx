        ...
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-white/10 bg-slate-950/70 p-6 shadow-2xl shadow-black/20">
              ...
              {!result && !loading ? (
                <div className="mt-6 rounded-2xl border border-dashed border-white/10 bg-slate-900/60 p-6 text-sm leading-8 text-slate-400">
                  Your reading will appear here as soon as you submit your birth details.
                </div>
              ) : null}
              ...
              {result ? (
                <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold text-white">AI reading</h4>
                    <div className="grid gap-4 lg:grid-cols-2">
                      {readingSections.map((section, index) => (
                        <div key={`${section.slice(0, 12)}-${index}`} className="rounded-2xl border border-white/10 bg-slate-900/70 p-5 text-sm leading-7 text-slate-300">
                          <p>{section}</p>
                        </div>
                      ))}
                    </div>
